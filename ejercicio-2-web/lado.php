...
<head>
    ...
    <title>Octogono por su longitud</title>
...
<div class="container">
  <div class="abs-center">
    ...
    <h3 class="text-center font-italic">Calcular el Octógono por su longitud</h3>
    <br>
      <div class="form-group">
        <label for="cateto-a">Ingrese la longitud del lado en cm</label>
        <input type="number" name="lado" id="email" class="form-control">
      </div>
